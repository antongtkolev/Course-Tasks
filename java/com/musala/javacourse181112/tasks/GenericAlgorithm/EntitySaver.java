package java.com.musala.javacourse181112.tasks.GenericAlgorithm;
...
public class EntitySaver {
    ...
    public <T extends Entity> void entitySaver(final T entity) throws IOException {
        ...
        Path path = Paths.get("src" + File.separator + "main" + File.separator + "resources" + File.separator + "GenericAlgorithm");
        path.toFile().mkdirs();
